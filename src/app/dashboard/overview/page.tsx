...
function docStatusLabel(status: DocStatus) {
  switch (status) {
    ...
    default:
      return { text: 'Not Provided', color: 'text-amber-500' };
  }
}
  ...
  return (
    <div className="space-y-6">
      ...
      <div
        ...
        style={{
          background:
            'linear-gradient(135deg, #b85e04 0%, #d89a33 55%, #e8b050 100%)',
        }}
      >
        <div className="absolute -top-8 -right-8 h-48 w-48 rounded-full bg-white/10" />
        <div className="absolute right-16 -bottom-12 h-64 w-64 rounded-full bg-white/5" />
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-white p-6">
          ...
          {rides.loading ? (
            ...
            <div className="mt-4">
              <SectionError message={rides.error} onRetry={rides.refetch} />
            </div>
            ...
            <div className="mt-4">
              <EmptyState
                ...
                action={
                  <Link
                    href="/dashboard/rides/publish"
                    className="inline-flex items-center gap-2 rounded-xl bg-[var(--primary)] px-4 py-2 text-sm font-semibold text-white hover:bg-[var(--primary-hover)]"
                  >
                ...
                return (
                  ...
                  >
                    <div className="flex w-[46px] shrink-0 flex-col items-center rounded-xl bg-[var(--primary-light)] py-2">
                      <span className="text-lg leading-none font-bold text-[var(--heading)]">
                        {dt.date}
                      </span>
                      <span className="mt-0.5 text-[10px] font-medium text-[var(--primary)]">
                        {dt.month}
                      </span>
                ...
                {verification.data.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-1.5">
                        <span className={'text-xs font-semibold ' + sl.color}>
                          {sl.text}
                        </span>
                ...
                <EmptyState
                  ...
                  action={
                    <Link
                      ...
                      className="inline-flex items-center gap-2 rounded-xl border border-[var(--primary)] px-4 py-2 text-sm font-medium text-[var(--primary)] hover:bg-[var(--primary-light)]"
                    >
                      Add Vehicle
                    </Link>
                  }
              ...
              <div className="mt-4 flex items-center gap-4">
                <div className="flex h-16 w-24 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-gray-50">
                  {vehicle.data.imageUrl ? (
                    <img
                      src={vehicle.data.imageUrl}
                      alt={vehicle.data.model}
...
function PassengerDashboard({ user }: { user: CurrentUser }) {
  const stats = useAsyncData(() => dashboardService.getPassengerStats(), [], {
    cacheKey: 'passenger-stats',
  });
  const trips = useAsyncData(() => dashboardService.getUpcomingTrips(), [], {
    cacheKey: 'passenger-upcoming-trips',
  });
  const bookings = useAsyncData(
    () => dashboardService.getRecentBookings(),
    [],
    { cacheKey: 'passenger-recent-bookings' },
  );
        ...
        {stats.loading ? (
          ...
          <>
            ...
            <StatsCard
              ...
              value={
                stats.data
                  ? stats.data.profileVerified
                    ? 'Verified'
                    : 'Incomplete'
                  : '—'
              }
              subtitle={
                stats.data && stats.data.profileVerified
                  ? "You're good to go!"
                  : 'Complete your profile'
              }
              valueColor={
                stats.data && stats.data.profileVerified ? 'green' : 'default'
              }
          ...
          <div className="mt-5 flex flex-wrap items-center gap-2 rounded-2xl bg-white p-2 shadow-lg">
            <div className="flex min-w-[140px] flex-1 items-center gap-2 rounded-xl px-3 py-2">
              ...
              <input
                type="text"
                placeholder="From"
                className="w-full bg-transparent text-sm text-[var(--heading)] outline-none placeholder:text-[var(--text-light)]"
              />
            </div>
            ...
            <div className="flex min-w-[130px] flex-1 items-center gap-2 rounded-xl px-3 py-2">
              ...
              <input
                type="date"
                className="w-full bg-transparent text-sm text-[var(--heading)] outline-none"
              />
            </div>
            <Link
              href="/dashboard/rides"
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-white p-6">
          ...
          {trips.loading ? (
            ...
            <div className="mt-4">
              <SectionError message={trips.error} onRetry={trips.refetch} />
            </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-white p-6">
          ...
          {profileVerif.loading ? (
            ...
            <div className="mt-4">
              <SectionError
                message={profileVerif.error}
                onRetry={profileVerif.refetch}
              />
            </div>
                ...
                <div className="flex items-center gap-1.5">
                  <span
                    className={
                      ...
                      (profileVerif.data.emailVerified
                        ? 'text-green-600'
                        : 'text-amber-500')
                    }
                  >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1.5">
                  <span
                    className={
                      'text-sm font-semibold ' +
                      (profileVerif.data.contactVerified
                        ? 'text-green-600'
                        : 'text-amber-500')
                    }
                  >
            ...
            {[
              {
                ...
                desc: 'All our drivers are verified and trusted',
              },
              {
                icon: MapPin,
                label: 'Live Trip Tracking',
                desc: 'Share your trip with family and friends',
              },
              {
                icon: Phone,
                label: 'Emergency Support',
                desc: '24/7 support for any travel assistance',
              },
            ].map((item) => (
